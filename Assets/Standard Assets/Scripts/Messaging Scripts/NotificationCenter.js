...
//======================================================================================================================================================================================
//EXAMPLE OF SENDING A NOTIFICATION: NotificationCenter.DefaultCenter().PostNotification(this, "TitleOfNotification", anyObject("String", Int, Float, GameObject, whatev) );

//EXAMPLE OF ADDING AN OBSERVER: NotificationCenter.DefaultCenter().AddObserver(this, "TitleOfNotification");

//EXAMPLE OF REMOVING AN OBSERVER: NotificationCenter.DefaultCenter().RemoveObserver(this, "TitleOfNotification");

/* EXAMPLE OF A LISTENERS FUNCTION TO HANDLE THE POSTED INFO
